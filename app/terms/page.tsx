...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://1Flex.live/terms',
  },
};
      ...
      <div className="max-w-2xl mx-auto relative border-x border-zinc-800/40 bg-gradient-to-b from-zinc-950/40 to-black/60 backdrop-blur-md shadow-[0_0_50px_rgba(0,0,0,0.8)] rounded-xl">
        ...
        <div className="px-6 sm:px-12 py-16 relative z-10 space-y-24">
          ...
          <div className="space-y-6 text-zinc-300 font-normal text-sm sm:text-base leading-relaxed tracking-wide">
            <p>
              By accessing <span className="text-white font-medium">1Flex</span>, you enter a mutual alliance to respect the pure, unfiltered spirit of art and exploration. This isn&apos;t a corporate trap designed to strip your user rights—it is a functional operating manual to ensure our interface remains stable, clean, and uncorrupted.
            </p>
            <p>
              ...
              <div className="flex gap-4 items-start">
                ...
                <div>
                  ...
                  <p className="text-zinc-400 text-sm leading-relaxed">
                    1Flex grants you a non-exclusive, immediate personal access pathway to curate lists, explore film meta-structures, and organize your media pools. You agree not to map, harvest, or extract data arrays from our site architecture via malicious automated bots, scraper frameworks, or heavy stress vectors.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="relative group">
              <div className="flex gap-4 items-start">
                ...
                <div>
                  ...
                  <p className="text-zinc-400 text-sm leading-relaxed">
                    1Flex functions as a high-fidelity rendering pipeline. Our catalogs are generated seamlessly via metadata sets provided directly by The Movie Database (TMDB). We do not officially claim ownership of copyrighted promotional banners, film logs, or cast poster graphics rendered through their open API streams.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="p-6 rounded-xl bg-gradient-to-br from-zinc-900/40 to-zinc-950/80 border border-zinc-900 text-center relative overflow-hidden">
            ...
            <p className="text-xs text-zinc-400 leading-relaxed max-w-md mx-auto">
              We reserve the right to upgrade these core protocols to maintain alignment with updated security standards. Continued utilization of <span className="text-white font-medium">1Flex.live</span> establishes full consent to this pact.
            </p>
          </div>
