...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://1Flex.app/cookies',
  },
};
      ...
      <div className="max-w-2xl mx-auto relative border-x border-zinc-800/40 bg-gradient-to-b from-zinc-950/40 to-black/60 backdrop-blur-md shadow-[0_0_50px_rgba(0,0,0,0.8)] rounded-xl">
        ...
        <div className="px-6 sm:px-12 py-16 relative z-10 space-y-24">
          ...
          <div className="space-y-6 text-zinc-300 font-normal text-sm sm:text-base leading-relaxed tracking-wide">
            <p>
              Like the small physical slots that hold a film strip locked steady inside a projector gate, <span className="text-white font-medium">1Flex</span> uses tiny data elements (cookies and local browser storage) exclusively to keep your custom configuration intact.
            </p>
            <p>
              ...
              <div className="flex gap-4 items-start">
                ...
                <div>
                  ...
                  <p className="text-zinc-400 text-sm leading-relaxed">
                    We completely reject third-party behavioral cookies, affiliate cross-site tracking pixels, and behavioral retargeting arrays. No marketing engines will spy on what titles you review or search files you activate on 1Flex to serve you targeted ad traps across the web.
                  </p>
                </div>
              </div>
            </div>
