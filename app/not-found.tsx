...
export const metadata: Metadata = {
  title: '404 - Page Not Found | 1Flex',
  description: 'The page you are looking for is not available on 1Flex. Return to home to continue streaming movies and TV shows.',
};
    ...
    <div className="min-h-screen bg-[#05050A] flex flex-col items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center text-center max-w-2xl">
        ...
        <div className="mt-8 mb-4 inline-flex items-center gap-3 px-4 py-1.5 rounded-full border border-[#1F2937] bg-black/50 backdrop-blur-sm">
          ...
          <span className="text-xs font-mono text-gray-400 uppercase tracking-widest">Page Not Found</span>
        </div>
        ...
        <p className="text-gray-400 mb-12 text-sm md:text-base leading-relaxed max-w-md">
          The movie, TV show, or page you&apos;re searching for seems to be missing from our library. Let&apos;s get you back to streaming.
        </p>
