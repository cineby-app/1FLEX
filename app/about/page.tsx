...
export const metadata: Metadata = {
  title: 'Our Story | 1Flex',
  description: 'Built by cinema lovers for cinema lovers. The raw, unfiltered story of why we created 1Flex to rescue the true art of filmmaking from the corporate algorithms.',
  alternates: {
    canonical: 'https://1Flex.live/about',
  },
};
        ...
        <div className="px-6 sm:px-12 py-16 relative z-10 space-y-28">
          ...
          <div className="relative border-b border-zinc-900/60 pb-16">
            ...
            <div className="space-y-6 text-zinc-300 font-normal text-sm sm:text-base leading-relaxed tracking-wide">
              <p>
                Let’s skip the sterile corporate definitions. We didn’t build <span className="text-white font-semibold">1Flex</span> because we detected an unexploited market gap, nor did we build it to package and trade your preferences. We built it because we are entirely, unapologetically captivated by the power of the frame. 
              </p>
              <p>
          ...
          <div className="relative border-b border-zinc-900/60 pb-16">
            ...
            <div className="space-y-6 text-zinc-300 font-normal text-sm sm:text-base leading-relaxed tracking-wide">
              <p>
                1Flex is an open haven engineered exclusively for creators, film collectors, midnight directors, and anyone who fundamentally believes that magnificent stories save lives. We are dedicated to keeping your interaction with the medium pure, immediate, and inspiring.
              </p>
              <p>
          ...
          <div className="text-center relative pt-4">
            ...
            <p className="text-2xl font-black text-white uppercase tracking-tighter drop-shadow-[0_4px_12px_rgba(255,255,255,0.05)]">
              1Flex <span className="text-zinc-600">—</span> FOR THE CINEMA LOVERS.
            </p>
          </div>
