...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://1Flex.live/privacy',
  },
};
      ...
      <div className="max-w-2xl mx-auto relative border-x border-zinc-800/40 bg-gradient-to-b from-zinc-950/40 to-black/60 backdrop-blur-md shadow-[0_0_50px_rgba(0,0,0,0.8)] rounded-xl">
        ...
        <div className="px-6 sm:px-12 py-16 relative z-10 space-y-24">
          ...
          <div className="space-y-6 text-zinc-300 font-normal text-sm sm:text-base leading-relaxed tracking-wide">
            <p>
              Just as we refuse to let automated corporate algorithms dictate what movies you discover, we completely refuse to commodify your interactive presence. 1Flex is a sanctuary built for film curators, which means your viewing logs, search flows, and library configurations belong entirely to you.
            </p>
            <p>
              ...
              <div className="flex gap-4 items-start">
                ...
                <div>
                  ...
                  <p className="text-zinc-400 text-sm leading-relaxed mb-4">
                    When you customize your workspace on 1Flex, we strictly preserve only the fundamental components required to support your account interface: your account credentials, selected library lists, ratings, and display configurations. 
                  </p>
            ...
            <div className="relative group">
              <div className="flex gap-4 items-start">
                ...
                <div>
                  ...
                  <p className="text-zinc-400 text-sm leading-relaxed">
                    1Flex uses local storage and fundamental, essential session elements purely to remember who you are logged in as and to keep your customized themes locked into your screen design. We run completely clear of tracking pixels, analytical profiling arrays, or cross-site tracking scripts.
                  </p>
                </div>
              </div>
            </div>
