...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      title: `${article.title} | 1Flex Blog`,
      description: article.excerpt,
            ...
            dangerouslySetInnerHTML={{
              __html: JSON.stringify({
                ...
                "author": {
                  "@type": "Person",
                  "name": article.author,
                  "url": `https://1Flex.com/author/${article.author.toLowerCase().replace(/\s+/g, '-')}`,
                },
                "publisher": {
                  "@type": "Organization",
                  "name": "1Flex",
                  "logo": {
                    "@type": "ImageObject",
                    "url": "https://1Flex.com/img/header-logo.png",
                  },
                },
                "mainEntityOfPage": {
                  "@type": "WebPage",
                  "@id": `https://1Flex.com/blog/${article.slug}`,
                },
                "keywords": article.keywords.join(', '),
              }),
            }}
